...
class GameItem:
    def __init__(self, name, full_path, category, var, checkbox):
        ...
        self.size_bytes = None    # calculated when needed
...
class XboxGameCopierApp(tk.Tk):
    def __init__(self):
        ...
        self.title("Xbox 360 Game Selector (Python v3)")
    ...
    def create_widgets(self):
        ...
        # NEW: Scan destination for existing games
        ...
        # NEW: Progress bar for copy process
    ...
    def auto_select_popular_2tb(self):
        ...
        # First clear current selection, but leave copied/disabled untouched
        for g in self.game_items:
    ...
    def copy_selected(self):
        selected_games = [g for g in self.game_items if g.var.get() and not g.copied and not g.exists_in_dest]
        ...
        for idx, g in enumerate(selected_games, start=1):
            try:
